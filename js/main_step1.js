...
var AirPlane = function(){
  ...
  // Create the cabin
	var geomCockpit = new THREE.BoxGeometry(30,30,30,1,1,1);
  ...
  var geomSideWing = new THREE.BoxGeometry(20,20,20,1,1,1);
  ...
  var geomPropeller = new THREE.BoxGeometry(20,10,10,1,2,1);
  ...
  var geomBlade = new THREE.BoxGeometry(10,200,5,1,1,1);
  var matBlade = new THREE.MeshPhongMaterial({color:Colors.blue,transparent:true,opacity:.6,shading:THREE.FlatShading});

  var blade1 = new THREE.Mesh(geomBlade, matBlade);
  blade1.position.set(0,10,10);
  ...
  this.propeller.position.set(-25,10,10);
